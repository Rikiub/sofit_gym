...
export default class FormDataJson {
     ...
     */
    static toJson(el, toJsonOptions) {
         ...
         * @return {Object|Array}
         */
        function removeEmpty(object, depth = 0) {
            const newObject = FormDataJson.isArray(object) ? [] : {};
            let count = 0;
            for (let key in object) {
     ...
     */
    static fromJson(el, values, fromJsonOptions) {
        if (!FormDataJson.isObject(values) && !FormDataJson.isArray(values)) {
            return;
        }
        const options = FormDataJson.merge(FormDataJson.defaultOptionsFromJson, fromJsonOptions);
     ...
     */
    static reset(el, resetOptions = undefined) {
     ...
     */
    static clear(el, clearOptions = undefined) {
     ...
     * @private
     */
    static setInputValue(row, newValue, triggerChangeEvent = false) {
     ...
     * @private
     */
    static getFieldTree(checkEl, isValidInput = null, options) {
